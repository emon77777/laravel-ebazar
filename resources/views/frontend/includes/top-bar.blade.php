    ...
    <div class="container">
        <div class="row align-items-center">
			...
			c0.8,0,1.5-0.1,2.3-0.2C469.556,223.306,474.556,216.306,473.256,209.006z"/>
                                ...
                                <span class="text">{{ maanAppearance('hotline_number') }}</span>
                            </a>
                        </li>
			...
			c8.912,0,16.134-7.223,16.134-16.134C196.303,151.895,189.08,144.672,180.168,144.672z"/></svg>
                                    ...
                                    <span class="text">{{ __('Track Your Order') }}</span>
                                </a>
                            </li>
                        @endif
                    </ul>
                        ...
                        @if(maanHeader('show_language'))
                            <li>
                                <div class="dropdown help-manu">
                                    <button class="dropdown-toggle" type="button" id="dropdownHelpManu" data-bs-toggle="dropdown" aria-expanded="false">{{ __('English') }}</button>
