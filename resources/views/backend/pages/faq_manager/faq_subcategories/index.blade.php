...
@section('content')
    <div class="content-body">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="faq-subcategory" role="tabpanel" aria-labelledby="faq-subcategory-tab">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="float-md-end">
                                <a href="{{route('backend.faq_subcategory.create')}}">
                                    <button class="btn btn-warning pull-right"> {{ __('Add FAQ SubCategory') }}</button>
                                </a>
    ...
    <script>
        $(function () {
            ...
            $(document).ready(function(){
                ...
                table.DataTable({
                    ajax: "{{route('backend.faq_subcategory.list')}}",
                    columns: [
                        { data: 'name' },
