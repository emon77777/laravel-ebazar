    ...
    <div class="content-body">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="add-category" role="tabpanel" aria-labelledby="add-category-tab">
                ...
                <div class="container">
                    <form id="faqForm" method="post" action="{{route('backend.faq_content.update',$faq->id)}}" enctype="multipart/form-data" class="add-brand-form">
                        @csrf()
                        @method('PUT')
                        @include('backend.pages.faq_manager.faq.form')
